...
@section('title', 'Edit Hero Slide - Admin Panel')
...
<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-6">
      <div>
        <h4 class="mb-1">Edit Hero Slide: {{ $heroSlide->title }}</h4>
        <p class="mb-0">Update slide content and settings</p>
      </div>
            ...
            <div class="card-body">
              <div class="mb-4">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                       id="title" name="title" value="{{ old('title', $heroSlide->title) }}"
              ...
              <div class="mb-4">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" 
                          ...
                          placeholder="Add custom HTML content here (optional)">{{ old('content', $heroSlide->content) }}</textarea>
              ...
              <div class="mb-4">
                ...
                @error('content_file')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                @if($heroSlide->content_file)
                  <div class="alert alert-info mt-3" role="alert">
                    <i class="icon-base ti tabler-file-description me-2"></i>
                    Current content file: <code>{{ basename($heroSlide->content_file) }}</code>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="1" id="remove_content_file" name="remove_content_file">
                    <label class="form-check-label" for="remove_content_file">
                      Remove current content file
                    </label>
                  </div>
                @endif
              </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-3">
                  ...
                  <select class="form-select @error('button_style') is-invalid @enderror" 
                    ...
                    <option value="btn-primary" {{ old('button_style', $heroSlide->button_style) == 'btn-primary' ? 'selected' : '' }}>Primary</option>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control @error('secondary_button_text') is-invalid @enderror" 
                         id="secondary_button_text" name="secondary_button_text" value="{{ old('secondary_button_text', $heroSlide->secondary_button_text) }}"
                ...
                <div class="col-md-5">
                  ...
                  <input type="text" class="form-control @error('secondary_button_link') is-invalid @enderror" 
                         id="secondary_button_link" name="secondary_button_link" value="{{ old('secondary_button_link', $heroSlide->secondary_button_link) }}"
              ...
              <div class="row mb-4">
                <div class="col-md-4">
                  ...
                  <select class="form-select @error('content_position') is-invalid @enderror" 
                    ...
                    <option value="left" {{ old('content_position', $heroSlide->content_position) == 'left' ? 'selected' : '' }}>Left</option>
                    <option value="center" {{ old('content_position', $heroSlide->content_position ?? 'center') == 'center' ? 'selected' : '' }}>Center</option>
                    <option value="right" {{ old('content_position', $heroSlide->content_position) == 'right' ? 'selected' : '' }}>Right</option>
                  </select>
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" class="form-control @error('background_color') is-invalid @enderror" 
                         id="background_color" name="background_color" value="{{ old('background_color', $heroSlide->background_color ?? '#000000') }}">
                ...
                <div class="col-md-4">
                  ...
                  <input type="color" class="form-control @error('text_color') is-invalid @enderror" 
                         id="text_color" name="text_color" value="{{ old('text_color', $heroSlide->text_color ?? '#ffffff') }}">
                  @error('text_color')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="range" class="form-range @error('overlay_opacity') is-invalid @enderror" 
                         id="overlay_opacity" name="overlay_opacity" value="{{ old('overlay_opacity', $heroSlide->overlay_opacity ?? 50) }}"
                         min="0" max="100" step="5">
                  <div class="form-text">Current: <span id="opacity-value">{{ old('overlay_opacity', $heroSlide->overlay_opacity ?? 50) }}</span>%</div>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('animation_type') is-invalid @enderror" 
                    ...
                    <option value="fade" {{ old('animation_type', $heroSlide->animation_type) == 'fade' ? 'selected' : '' }}>Fade</option>
                    <option value="slide" {{ old('animation_type', $heroSlide->animation_type) == 'slide' ? 'selected' : '' }}>Slide</option>
                    <option value="zoom" {{ old('animation_type', $heroSlide->animation_type) == 'zoom' ? 'selected' : '' }}>Zoom</option>
                    <option value="none" {{ old('animation_type', $heroSlide->animation_type) == 'none' ? 'selected' : '' }}>None</option>
                  </select>
            ...
            <div class="card-body">
              <div class="mb-4">
                ...
                <input type="number" class="form-control @error('order') is-invalid @enderror" 
                       id="order" name="order" value="{{ old('order', $heroSlide->order) }}"
                       min="1" required>
              ...
              <div class="mb-4">
                ...
                <input type="number" class="form-control @error('auto_play_delay') is-invalid @enderror" 
                       id="auto_play_delay" name="auto_play_delay" value="{{ old('auto_play_delay', $heroSlide->auto_play_delay ?? 5000) }}"
            ...
            <div class="card-body">
              @if($heroSlide->image)
                <div class="mb-3 text-center">
                  <img src="{{ $heroSlide->image_url }}" alt="Current Slide Image" 
              ...
              <div class="mb-3">
                ...
                <div class="form-text">Max 5MB. Leave empty to keep current image</div>
                @error('image')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('image_alt') is-invalid @enderror" 
                       id="image_alt" name="image_alt" value="{{ old('image_alt', $heroSlide->image_alt) }}"
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control @error('display_from') is-invalid @enderror" 
                       id="display_from" name="display_from" value="{{ old('display_from', $heroSlide->display_from ? $heroSlide->display_from->format('Y-m-d\TH:i') : '') }}">
              ...
              <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control @error('display_to') is-invalid @enderror" 
                       id="display_to" name="display_to" value="{{ old('display_to', $heroSlide->display_to ? $heroSlide->display_to->format('Y-m-d\TH:i') : '') }}">
          ...
          <div class="card">
            <div class="card-body">
              <button type="submit" class="btn btn-primary w-100 mb-2">
                <i class="icon-base ti tabler-check me-2"></i>Update Slide
              </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeImageBtn?.addEventListener('click', function() {
        if (confirm('Are you sure you want to remove the current hero slide image?')) {
            imageInput.value = '';
            previewImg.src = '';
