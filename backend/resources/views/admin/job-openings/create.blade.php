...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Create Job Opening</h4>
    ...
    <form action="{{ route('admin.job-openings.store') }}" method="POST" class="card p-4">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="employment_type" id="employment_type" class="form-select">
                    <option value="" {{ old('employment_type') == '' ? 'selected' : '' }}>Select type</option>
            ...
            <div class="col-md-6">
                ...
                <input type="datetime-local" name="display_from" id="display_from" class="form-control" value="{{ old('display_from') }}">
            </div>
            <div class="col-md-6">
                <label for="display_to" class="form-label">Display To</label>
                <input type="datetime-local" name="display_to" id="display_to" class="form-control" value="{{ old('display_to') }}">
            </div>

            <div class="col-md-4">
                <label for="order" class="form-label">Order</label>
                <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $nextOrder) }}" min="1">
            </div>
        </div>
