  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-6">
      <div>
        ...
        <p class="mb-0">Update testimonial information</p>
      </div>
      ...
      <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="mb-4">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" 
                          ...
                          placeholder="Enter the testimonial content..." required>{{ old('content', $testimonial->content) }}</textarea>
                @error('content')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                  ...
                  @for($i = 1; $i <= 5; $i++)
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="rating" id="rating{{ $i }}" 
                             value="{{ $i }}" {{ old('rating', $testimonial->rating) == $i ? 'checked' : '' }}>
        ...
        <div class="col-12 col-lg-4">
          ...
          @if($testimonial->image)
            <div class="card mb-6">
              <div class="card-header">
                <h5 class="mb-0">Current Photo</h5>
              </div>
              <div class="card-body text-center">
                <img src="{{ $testimonial->image_url }}" alt="{{ $testimonial->name }}" 
                     class="img-fluid rounded mb-3" style="max-height: 200px;">
                <p class="text-muted">Current customer photo</p>
              </div>
            </div>
          @endif
          ...
          <div class="card mb-6">
            <div class="card-header">
              <h5 class="mb-0">{{ $testimonial->image ? 'Change Photo' : 'Customer Photo' }}</h5>
            </div>
            <div class="card-body">
              <div class="mb-4">
                ...
                @error('image')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <div class="form-text">Upload new photo (optional). Max size: 2MB</div>
              </div>
              ...
              <div class="mb-4">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" name="status" id="status" 
                         value="1" {{ old('status', $testimonial->status) ? 'checked' : '' }}>
          ...
          <div class="card">
            <div class="card-body">
              <button type="submit" class="btn btn-primary w-100 mb-3">
                <i class="icon-base ti tabler-check me-2"></i>Update Testimonial
              </button>
...
function removeImage() {
    if (confirm('Are you sure you want to remove the current image?')) {
        ...
        if (!form.querySelector('input[name="remove_image"]')) {
