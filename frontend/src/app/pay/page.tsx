        ...
        <div className="grid gap-8 md:grid-cols-2 mb-15">
          ...
          <div className="border rounded-2xl shadow hover:shadow-lg transition overflow-hidden">
            ...
            <div className="p-6 flex flex-col items-center">
              ...
              <Image
                src="https://api.rssolutionsindia.co.in/storage/gallery/8F9rdpWPWrvoW2Dd7Lv8XbFiL8lH8egR2ID1HH5V.jpg"
                alt="PayU QR Code"
                width={400}
                height={400}
          ...
          <div className="border rounded-2xl shadow hover:shadow-lg transition overflow-hidden">
            ...
            <div className="p-6 flex flex-col items-center">
              ...
              <Image
                src="https://api.rssolutionsindia.co.in/storage/gallery/QHUpy2CYbCtvgZmmCUHs4QfOAiuDFcwkkCmLkIvO.png"
                alt="Paytm QR Code"
                width={400}
                height={400}
                className="mt-4 w-56 md:w-64 h-auto rounded-md border border-gray-200"
