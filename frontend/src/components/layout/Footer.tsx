            ...
            <div className="space-y-6">
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Link
                    href="https://play.google.com/store/apps/details?id=com.RSSolution.Attendance&pcampaignid=web_share"
                    target="_blank"
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li className="flex items-center gap-2 hover:text-orange-500 transition-colors">
                  ...
                  >
                    ...
                    <span>wa.me/realtimebiometrics</span>
                  </a>
                </li>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              ...
              >
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${status === "loading"
